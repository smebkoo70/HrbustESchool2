...
public class PersonPageAdapter extends BaseAdapter {
    ...
    public PersonPageAdapter(Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = mlayoutInflater.inflate(R.layout.personpageitem,null);
