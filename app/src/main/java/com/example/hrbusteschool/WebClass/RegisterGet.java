...
public class RegisterGet {
    public static String executeHttpGet(String username,String password,String tel,String sex,String address){
        ...
        try{
            ...
            String path = Url + "?username=" + username + "&password=" + password + "&tel=" + tel + "&sex=" + sex;
            try {
